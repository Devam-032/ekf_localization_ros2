...
def generate_launch_description():
    ...
    ekf_slam_dir = get_package_share_directory('ekf_slam')
    
    # Use the specified RViz configuration file location directly
    rviz_config_path = '/home/devam/FYP_ROS2/src/ekf_slam/rviz_config/slam_config.rviz'

    # Include the TurtleBot3 empty world launch file (this will start Gazebo)
    fyp_world_launch = IncludeLaunchDescription(
    ...
    ld.add_action(fyp_world_launch)
